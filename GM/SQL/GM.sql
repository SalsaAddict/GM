...
CREATE PROCEDURE [apiGenres](@UserId NVARCHAR(255) = NULL)
AS
BEGIN
	SET NOCOUNT ON
...
CREATE PROCEDURE [apiStyles](@GenreId INT, @UserId NVARCHAR(255) = NULL)
AS
BEGIN
	SET NOCOUNT ON
	SET TRANSACTION ISOLATION LEVEL READ UNCOMMITTED
...
BEGIN
	...
	SET @Error = CONVERT(NVARCHAR(max), @Styles)
